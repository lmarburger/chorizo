...
async function testErrorHandling() {
  ...
  try {
    ...
    assert(message.includes("duplicate key") || message.includes("already exists"), "Should throw duplicate key error");
  }
}
...
const tests: { name: string; fn: () => Promise<void> }[] = [
  { name: "Add chore with schedules", fn: testAddChoreWithSchedules },
  { name: "Update chore", fn: testUpdateChore },
  { name: "Update chore schedules", fn: testUpdateChoreSchedules },
  { name: "Chore completion toggle", fn: testChoreCompletion },
  { name: "Get chores for kid", fn: testGetChoresForKid },
  { name: "Get unique kid names", fn: testGetUniqueKidNames },
  { name: "Delete chore cascade", fn: testDeleteChore },
  { name: "Get chore by ID", fn: testGetChoreById },
  { name: "Add and get task", fn: testAddTask },
  { name: "Update task", fn: testUpdateTask },
  { name: "Task completion toggle", fn: testTaskCompletion },
  { name: "Get tasks for kid", fn: testGetTasksForKid },
  { name: "Task priority sorting", fn: testTaskPrioritySorting },
  { name: "Delete task", fn: testDeleteTask },
  { name: "Completed tasks week boundary", fn: testCompletedTasksWeekBoundary },
  { name: "Tasks for parent view", fn: testTasksForParentView },
  { name: "Error handling", fn: testErrorHandling },
  { name: "Unified sorting", fn: testUnifiedSorting },
  { name: "Excuse chore", fn: testExcuseChore },
  { name: "Excuse task", fn: testExcuseTask },
  { name: "Fixed vs flexible chores", fn: testFixedFlexibleChores },
  { name: "Weekly qualification", fn: testWeeklyQualificationQualified },
  { name: "Incentive claim", fn: testIncentiveClaim },
  { name: "Late completion detection", fn: testLateCompletionDetection },
  { name: "Late completion disqualifies", fn: testLateCompletionDisqualifies },
  { name: "Excuse late completion restores qualification", fn: testExcuseLateCompletionRestoresQualification },
  { name: "Flexible chores not marked late", fn: testFlexibleChoresNotMarkedLate },
];
