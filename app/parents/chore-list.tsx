  ...
  return (
    <div className="space-y-8">
      {Object.entries(choresByKid).map(([kidName, kidChores]) => (
        <div key={kidName} className="rounded-lg bg-white p-4 shadow dark:bg-gray-800">
          <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white">{kidName}'s Chores</h2>
